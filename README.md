...
I am an **Android App Modder** currently at an **Intermediate Stage**. My work involves deep-level modification and analysis of application structures.

* 🔓 **Modding Expertise:** Bypassing license handlers and unlocking premium layers.
* ⚙️ **RE Skills:** Intermediate analysis of Smali and XML files.
* 📈 **Focus:** Constantly evolving from medium-stage modding to professional engineering.

---

### 🛠️ CORE MODDING TOOLKIT
I use specialized tools for reverse engineering and application patching:
* 📱 **Mobile Power:** MT Manager, APKTool M, Current Activity+, Modder Hub.
* 💻 **Desktop:** VS Code, Android Studio, Python.

<p align="center">
  <img src="https://skillicons.dev/icons?i=androidstudio,java,kotlin,linux,git,github,vscode,py,cpp&theme=dark" />
</p>
